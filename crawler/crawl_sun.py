...
# ============================================================
products = {
    "라운드랩_자작나무_수분_선크림": "A000000149135",
    ...
    #"넘버즈인_3번_도자기결_톤업베이지_선크림": "A000000250767",
    #"풀리_쌀_세라_수분_선크림": "A000000240562",
    #"프롬리에 비건 EGF 시카 선앰플": "A000000209372",
}
...
df.to_csv("reviews_선케어.csv", index=False, encoding="utf-8-sig")

print(f"\n완료! 총 {len(df)}건 저장 → reviews_선케어.csv")